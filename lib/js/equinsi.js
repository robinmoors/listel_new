...
EQ = {
    ...
    ajaxProcess : function(o){
        ...
        this.start = function(){
            if(this.check()){
                ...
                if(this.parameters) this.xhr.send(this.parameters);
                else this.xhr.send();
            }else{
                this.state = "ofail";
                this.ready = true;
    ...
    formCheck:function(elem,l,ml,pref,email){
        var prefix = pref || "";
        var b = true;
        var elemn = elem.name;
    ...
    overflow:function(o){
        ...
        this.button = o.button || "<a class='RoundedButton2' tabIndex='2' onclick='EQ.OVR.close();'><img src='http://moorskeshoeve.be/lib/img/spacer.png' title='sluiten' alt='' class='icon round closeround' width='48px' height='48px'/></a>";
        this.attached = false;
