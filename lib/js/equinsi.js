...
EQ = {
    ...
    overflow:function(o){
        ...
        this.button = o.button || "<a class='RoundedButton2' tabIndex='2' onclick='EQ.OVR.close();'><img src='http://localhost/listel_new/lib/images/Close.png' title='sluiten' alt=''/></a>";
        this.attached = false;
        ...
        switch(url){
            case "home": url = "http://localhost/listel_new/ecareplan/home/welkom/"; break;
            case "login": url = "http://localhost/listel_new/ecareplan/login/login/"; break;
            default: break;
        }
        url+=EQ.getUid();
