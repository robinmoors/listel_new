...
function stream($options=''){
  ...
  $fileName = (isset($options['Content-Disposition'])?$options['Content-Disposition']:'file' . date("His") .'.pdf');
...
function setFontFamily($family,$options=''){
  ...
  if (!is_array($options)){
    ...
    if ($family=='init'){
      ...
      $this->fontFamilies['DroidSans.afm']=array(

         'b'=>'DroidSans-Bold.afm'

        ,'i'=>'DroidSans.afm'

        ,'bi'=>'DroidSans-Bold.afm'

        ,'ib'=>'DroidSans-Bold.afm'
