...
if (IsSet($_SESSION["toegang"])&&($_SESSION["toegang"]=="toegestaan"))
    ...
    $datum=mysql_fetch_array(mysql_query("SELECT datum, soort_problematiek FROM  overleg WHERE id=$overlegID")) or die("kan den datum niet ophalen");
...
EINDE;
    ...
    <input type="radio"> thuis verblijft. Er wordt verondersteld dat hij/zij nog ten minste 1 maand thuis zal blijven met een vermindering van $soortProblematiek zelfredzaamheid.

    <br /><br />

    <input type="radio"> opgenomen is in een instelling waarbij een terugkeer naar de thuisomgeving is gepland binnen de 8 dagen. Er wordt verondersteld dat hij nog ten minste 1 maand thuis zal blijven met een vermindering van $soortProblematiek zelfredzaamheid.
