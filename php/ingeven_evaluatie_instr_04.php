...
//	$_SESSION['overleg_id']=$_POST['overleg_id'];
   $paginanaam="Evaluatieinstrument Stap 4.";
...
function checkRadios(){var melding="";
	waarde=""
	var radios= new Array("ei_04_01_s","ei_04_02_s","ei_04_03_s","ei_04_04_s","ei_04_05_s","ei_04_06_s","ei_04_08_s","ei_04_09_s","ei_04_10_s","ei_04_11_s","ei_04_12_s","ei_04_13_s");
...
switch(true)
 ...
 // Reset values
		...
		if((isset($_SESSION['action']))AND($_SESSION['action']=="Aanpassen"))
			...
			$qry="
				SELECT
					ei_04_01_s,ei_04_01_t,
					ei_04_02_s,ei_04_02_t,
					ei_04_03_s,ei_04_03_t,
					ei_04_04_s,ei_04_04_t,
					ei_04_05_s,ei_04_05_t,
					ei_04_06_s,ei_04_06_t,
					ei_04_07_s,ei_04_07_t,
					ei_04_08_s,ei_04_08_t,
					ei_04_09_s,ei_04_09_t,
					ei_04_10_s,ei_04_10_t,
					ei_04_11_s,ei_04_11_t,
					ei_04_12_s,ei_04_12_t,
					ei_04_13_s,ei_04_13_t,
					ei_04_14_s,ei_04_14_t
				FROM
					evalinstr
    WHERE
...
?>
<form action="ingeven_evaluatie_instr_04.php" method="post" name="evaluatieInstrForm" onsubmit="return checkRadios()">
   <fieldset>
      ...
      <div class="waarde">
            ...
            <tr class="verplicht">
					<td colspan="6" class="titel">Bereiding :</td>
				</tr>
            <tr class="verplicht">
<?php 
...
?>
					<td>&nbsp;&nbsp;&bull;&nbsp;Ontbijt</td>
					<td align="center"><input type="text"  name="ei_04_01_t" size="35" value="<?php print($Var_ei_04_01_t);?>" /></td>
				</tr>
            <tr class="verplicht">
<?php 
...
?>
					<td>&nbsp;&nbsp;&bull;&nbsp;Warme maaltijd</td>
					<td align="center"><input type="text"  name="ei_04_02_t" size="35" value="<?php print($Var_ei_04_02_t);?>" /></td>
				</tr>
            <tr class="verplicht">
<?php 
...
?>
					<td>&nbsp;&nbsp;&bull;&nbsp;Avondmaal</td>
					<td align="center"><input type="text"  name="ei_04_03_t" size="35" value="<?php print($Var_ei_04_03_t);?>" /></td>
				</tr>
            <tr>
					<td colspan="6">&nbsp;</td>
				</tr>
...
?>
					<td>Vaat doen</td>
					<td align="center"><input type="text"  name="ei_04_04_t" size="35" value="<?php print($Var_ei_04_04_t);?>" /></td>
				</tr>
            <tr class="verplicht">
<?php 
...
?>
					<td>Bediening huishoudapp.</td>
					<td align="center"><input type="text"  name="ei_04_05_t" size="35" value="<?php print($Var_ei_04_05_t);?>" /></td>
				</tr>
            <tr class="verplicht">
<?php 
...
?>
					<td>Onderhoud woning / keuken</td>
					<td align="center"><input type="text"  name="ei_04_06_t" size="35" value="<?php print($Var_ei_04_06_t);?>" /></td>
				</tr>
            <tr>
<?php 
...
?>
					<td>Onderhoud tuin</td>
					<td align="center"><input type="text"  name="ei_04_07_t" size="35" value="<?php print($Var_ei_04_07_t);?>" /></td>
				</tr>
            <tr class="verplicht">
<?php 
...
?>
					<td>Verwijderen afval</td>
					<td align="center"><input type="text"  name="ei_04_08_t" size="35" value="<?php print($Var_ei_04_08_t);?>" /></td>
				</tr>
            <tr class="verplicht">
<?php 
...
?>
					<td>Wassen / drogen kleding</td>
					<td align="center"><input type="text"  name="ei_04_09_t" size="35" value="<?php print($Var_ei_04_09_t);?>" /></td>
				</tr>
            <tr class="verplicht">
<?php 
...
?>
					<td>Strijken</td>
					<td align="center"><input type="text"  name="ei_04_10_t" size="35" value="<?php print($Var_ei_04_10_t);?>" /></td>
				</tr>
            <tr class="verplicht">
<?php 
...
?>
					...
					<td align="center"><input type="text"  name="ei_04_11_t" size="35" value="<?php print($Var_ei_04_11_t);?>" /></td>
				</tr>
            <tr class="verplicht">
<?php 
...
?>
					<td>Administratieve verrichtingen</td>
					<td align="center"><input type="text"  name="ei_04_12_t" size="35" value="<?php print($Var_ei_04_12_t);?>" /></td>
				</tr>
            <tr class="verplicht">
<?php 
...
?>
					<td>Financi&euml;le verrichtingen</td>
					<td align="center"><input type="text"  name="ei_04_13_t" size="35" value="<?php print($Var_ei_04_13_t);?>" /></td>
				</tr>
            <tr>
<?php 
...
?>
					...
					<td align="center"><input type="text"  name="ei_04_14_t" size="35" value="<?php print($Var_ei_04_14_t);?>" /></td>
				</tr>
            </table>
      </div>
   </fieldset>
...
<?php
	...
	case((isset($_POST['action']))AND($_POST['action']=="Opslaan")):
		...
		$qry="
				UPDATE evalinstr
				SET
					ei_04_01_s=".check4empty('ei_04_01_s').",ei_04_01_t='".$_POST['ei_04_01_t']."',
					ei_04_02_s=".check4empty('ei_04_02_s').",ei_04_02_t='".$_POST['ei_04_02_t']."',
					ei_04_03_s=".check4empty('ei_04_03_s').",ei_04_03_t='".$_POST['ei_04_03_t']."',
					ei_04_04_s=".check4empty('ei_04_04_s').",ei_04_04_t='".$_POST['ei_04_04_t']."',
					ei_04_05_s=".check4empty('ei_04_05_s').",ei_04_05_t='".$_POST['ei_04_05_t']."',
					ei_04_06_s=".check4empty('ei_04_06_s').",ei_04_06_t='".$_POST['ei_04_06_t']."',
					ei_04_07_s=".check4empty('ei_04_07_s').",ei_04_07_t='".$_POST['ei_04_07_t']."',
					ei_04_08_s=".check4empty('ei_04_08_s').",ei_04_08_t='".$_POST['ei_04_08_t']."',
					ei_04_09_s=".check4empty('ei_04_09_s').",ei_04_09_t='".$_POST['ei_04_09_t']."',
					ei_04_10_s=".check4empty('ei_04_10_s').",ei_04_10_t='".$_POST['ei_04_10_t']."',
					ei_04_11_s=".check4empty('ei_04_11_s').",ei_04_11_t='".$_POST['ei_04_11_t']."',
					ei_04_12_s=".check4empty('ei_04_12_s').",ei_04_12_t='".$_POST['ei_04_12_t']."',
					ei_04_13_s=".check4empty('ei_04_13_s').",ei_04_13_t='".$_POST['ei_04_13_t']."',
					ei_04_14_s=".check4empty('ei_04_14_s').",ei_04_14_t='".$_POST['ei_04_14_t']."'
				WHERE
                    ei_id = {$_SESSION['evalinstr_id']}";
//			print($qry);
		...
		document.location=\"ingeven_evaluatie_instr_05.php\"
