...
//	$_SESSION['overleg_id']=$_POST['overleg_id'];
   $paginanaam="Evaluatieinstrument Stap 6.";
...
function checkRadios(){var melding="";
	waarde=""
	var radios= new Array("ei_06_06_s","ei_06_07_s","ei_06_05_s");
...
switch(true)
 ...
 // Reset values
		...
		if((isset($_SESSION['action']))AND($_SESSION['action']=="Aanpassen"))
			...
			$qry="
				SELECT
					ei_06_01_s,ei_06_01_t,
					ei_06_02_s,ei_06_02_t,
					ei_06_03_s,ei_06_03_t,
					ei_06_04_s,ei_06_04_t,
					ei_06_05_s,ei_06_05_t,
					ei_06_06_s,ei_06_06_t,
					ei_06_07_s,ei_06_07_t,
					ei_06_08_s,ei_06_08_t,
					ei_06_09_s,ei_06_09_t,
					ei_06_10_s,ei_06_10_t,
					ei_06_11_s,ei_06_11_t
				FROM
					evalinstr
				WHERE
...
?>
<form action="ingeven_evaluatie_instr_06.php" method="post" name="evaluatieInstrForm" onsubmit="return checkRadios()">
   <fieldset>
      ...
      <div class="waarde">
            ...
            <tr>
					<td colspan="6" class="titel">School :</td>
				</tr>
            <tr>
<?php 
...
?>
					<td>&nbsp;&nbsp;&bull;&nbsp;Aanwezigheid</td>
					<td align="center"><input type="text"  name="ei_06_01_t" size="35" value="<?php print($Var_ei_06_01_t);?>" /></td>
				</tr>
            <tr>
<?php 
...
?>
					<td>&nbsp;&nbsp;&bull;&nbsp;Huiswerk</td>
					<td align="center"><input type="text"  name="ei_06_02_t" size="35" value="<?php print($Var_ei_06_02_t);?>" /></td>
				</tr>
            <tr>
<?php 
...
?>
					<td>&nbsp;&nbsp;&bull;&nbsp;Leerproblemen</td>
					<td align="center"><input type="text"  name="ei_06_03_t" size="35" value="<?php print($Var_ei_06_03_t);?>" /></td>
				</tr>
            <tr>
					<td colspan="6">&nbsp;</td>
				</tr>
...
?>
					<td>Werk</td>
					<td align="center"><input type="text"  name="ei_06_04_t" size="35" value="<?php print($Var_ei_06_04_t);?>" /></td>
				</tr>
            <tr class="verplicht">
					<td colspan="6" class="titel">Recreatie: deelname aan activiteiten :</td>
				</tr>
            <tr class="verplicht">
<?php 
...
?>
					<td>&nbsp;&nbsp;&bull;&nbsp;Binnenhuis</td>
					<td align="center"><input type="text"  name="ei_06_05_t" size="35" value="<?php print($Var_ei_06_05_t);?>" /></td>
				</tr>
            <tr class="verplicht">
<?php 
...
?>
					<td>&nbsp;&nbsp;&bull;&nbsp;Buitenhuis</td>
					<td align="center"><input type="text"  name="ei_06_06_t" size="35" value="<?php print($Var_ei_06_06_t);?>" /></td>
				</tr>
            <tr>
					<td colspan="6">&nbsp;</td>
				</tr>
...
?>
					<td>Eventuele bezoekregeling(en)</td>
					<td align="center"><input type="text"  name="ei_06_07_t" size="35" value="<?php print($Var_ei_06_07_t);?>" /></td>
				</tr>
            <tr>
<?php 
...
?>
					<td>Problematische handelingen of gedragingen</td>
					<td align="center"><input type="text"  name="ei_06_08_t" size="35" value="<?php print($Var_ei_06_08_t);?>" /></td>
				</tr>
            <tr>
<?php 
...
?>
					<td>Verslavingsproblematiek</td>
					<td align="center"><input type="text"  name="ei_06_09_t" size="35" value="<?php print($Var_ei_06_09_t);?>" /></td>
				</tr>
            <tr>
<?php 
...
?>
					...
					<td align="center"><input type="text"  name="ei_06_10_t" size="35" value="<?php print($Var_ei_06_10_t);?>" /></td>
				</tr>
            <tr>
<?php 
...
?>
					<td>Individule aandachtspunten</td>
					<td align="center"><input type="text"  name="ei_06_11_t" size="35" value="<?php print($Var_ei_06_11_t);?>" /></td>
				</tr>
            </table>
      </div>
   </fieldset>
...
<?php
	...
	case((isset($_POST['action']))AND($_POST['action']=="Opslaan")):
		...
		$qry="
				UPDATE evalinstr
				SET
					ei_06_01_s=".check4empty('ei_06_01_s').",ei_06_01_t='".$_POST['ei_06_01_t']."',
					ei_06_02_s=".check4empty('ei_06_02_s').",ei_06_02_t='".$_POST['ei_06_02_t']."',
					ei_06_03_s=".check4empty('ei_06_03_s').",ei_06_03_t='".$_POST['ei_06_03_t']."',
					ei_06_04_s=".check4empty('ei_06_04_s').",ei_06_04_t='".$_POST['ei_06_04_t']."',
					ei_06_05_s=".check4empty('ei_06_05_s').",ei_06_05_t='".$_POST['ei_06_05_t']."',
					ei_06_06_s=".check4empty('ei_06_06_s').",ei_06_06_t='".$_POST['ei_06_06_t']."',
					ei_06_07_s=".check4empty('ei_06_07_s').",ei_06_07_t='".$_POST['ei_06_07_t']."',
					ei_06_08_s=".check4empty('ei_06_08_s').",ei_06_08_t='".$_POST['ei_06_08_t']."',
					ei_06_09_s=".check4empty('ei_06_09_s').",ei_06_09_t='".$_POST['ei_06_09_t']."',
					ei_06_10_s=".check4empty('ei_06_10_s').",ei_06_10_t='".$_POST['ei_06_10_t']."',
					ei_06_11_s=".check4empty('ei_06_11_s').",ei_06_11_t='".$_POST['ei_06_11_t']."'
				WHERE
                    ei_id = {$_SESSION['evalinstr_id']}";
//			print($qry);
		...
		document.location=\"ingeven_evaluatie_instr_07.php\"
