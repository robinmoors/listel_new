...
$query = "select $velden $select
          ...
          from afgeronde_betrokkenen lijst, patient, mantelzorgers mz, overleg $from

          where patient.code = overleg.patient_code and overleg.id = lijst.overleg_id and lijst.genre = 'mantel' and lijst.persoon_id = mz.id
...
$csvOutput = "Overleggen en hun mantelzorgers ({$_POST['soortOverleg']}) van $begin tot $eind\n\n";
