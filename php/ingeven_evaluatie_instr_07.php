...
//	$_SESSION['overleg_id']=$_POST['overleg_id'];
   $paginanaam="Evaluatieinstrument Stap 7.";
...
function checkRadios(){var melding="";
	waarde=""
	var radios= new Array("ei_07_01_s","ei_07_02_s","ei_07_03_s","ei_07_05_s","ei_07_06_s","ei_07_04_s","ei_07_07_s");
...
switch(true)
	...
	case(!(isset($_POST['action']))):
		...
		if((isset($_SESSION['action']))AND($_SESSION['action']=="Aanpassen"))
			...
			$qry="
				SELECT
					ei_07_01_s,ei_07_01_t,
					ei_07_02_s,ei_07_02_t,
					ei_07_03_s,ei_07_03_t,
					ei_07_04_s,ei_07_04_t,
					ei_07_05_s,ei_07_05_t,
					ei_07_06_s,ei_07_06_t,
					ei_07_07_s,ei_07_07_t,
					ei_07_08_s,ei_07_08_t
				FROM
					evalinstr
				WHERE
...
?>
<form action="ingeven_evaluatie_instr_07.php" method="post" name="evaluatieInstrForm" onsubmit="return checkRadios()">
   <fieldset>
...
?>
					<td>Naaste familie</td>
					<td align="center"><input type="text"  name="ei_07_01_t" size="35" value="<?php print($Var_ei_07_01_t);?>" /></td>
				</tr>
            <tr class="verplicht">
<?php 
...
?>
					<td>Verre familie</td>
					<td align="center"><input type="text"  name="ei_07_02_t" size="35" value="<?php print($Var_ei_07_02_t);?>" /></td>
				</tr>
            <tr class="verplicht">
<?php 
...
?>
					<td>Vrienden</td>
					<td align="center"><input type="text"  name="ei_07_03_t" size="35" value="<?php print($Var_ei_07_03_t);?>" /></td>
				</tr>
            <tr class="verplicht">
					<td colspan="6" class="titel">Persoonlijke verzorgers en assistenten (incl. vrijwilligers)</td>
				</tr>
            <tr class="verplicht">
<?php 
...
?>
					<td>&nbsp;&nbsp;&bull;&nbsp;Aan huis</td>
					<td align="center"><input type="text"  name="ei_07_04_t" size="35" value="<?php print($Var_ei_07_04_t);?>" /></td>
				</tr>
            <tr class="verplicht">
<?php 
...
?>
					...
					<td align="center"><input type="text"  name="ei_07_05_t" size="35" value="<?php print($Var_ei_07_05_t);?>" /></td>
				</tr>
            <tr class="verplicht">
					<td colspan="6" class="titel">Hulpverleners in de gezondheidszorg</td>
				</tr>
            <tr class="verplicht">
<?php 
...
?>
					<td>&nbsp;&nbsp;&bull;&nbsp;Aan huis</td>
					<td align="center"><input type="text"  name="ei_07_06_t" size="35" value="<?php print($Var_ei_07_06_t);?>" /></td>
				</tr>
            <tr class="verplicht">
<?php 
...
?>
					<td>&nbsp;&nbsp;&bull;&nbsp;Buitenhuis</td>
					<td align="center"><input type="text"  name="ei_07_07_t" size="35" value="<?php print($Var_ei_07_07_t);?>" /></td>
				</tr>
            <tr>
					<td colspan="6">&nbsp;</td>
				</tr>
...
?>
					...
					<td align="center"><input type="text"  name="ei_07_08_t" size="35" value="<?php print($Var_ei_07_08_t);?>" /></td>
				</tr>
            </table>
      </div>
   </fieldset>
...
<?php
	...
	case((isset($_POST['action']))AND($_POST['action']=="Opslaan")):
		...
		$qry="
				UPDATE evalinstr
				SET
					ei_07_01_s=".check4empty('ei_07_01_s').",ei_07_01_t='".$_POST['ei_07_01_t']."',
					ei_07_02_s=".check4empty('ei_07_02_s').",ei_07_02_t='".$_POST['ei_07_02_t']."',
					ei_07_03_s=".check4empty('ei_07_03_s').",ei_07_03_t='".$_POST['ei_07_03_t']."',
					ei_07_04_s=".check4empty('ei_07_04_s').",ei_07_04_t='".$_POST['ei_07_04_t']."',
					ei_07_05_s=".check4empty('ei_07_05_s').",ei_07_05_t='".$_POST['ei_07_05_t']."',
					ei_07_06_s=".check4empty('ei_07_06_s').",ei_07_06_t='".$_POST['ei_07_06_t']."',
					ei_07_07_s=".check4empty('ei_07_07_s').",ei_07_07_t='".$_POST['ei_07_07_t']."',
					ei_07_08_s=".check4empty('ei_07_08_s').",ei_07_08_t='".$_POST['ei_07_08_t']."'
				WHERE
                    ei_id = {$_SESSION['evalinstr_id']}";
			//print($qry);
		...
		document.location=\"ingeven_evaluatie_instr_081.php\"
