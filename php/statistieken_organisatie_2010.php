...
select sum(locatie=0) as thuis, sum(locatie=1) as elders, organisatie.*
                              ...
                              where (overleg.genre is NULL or overleg.genre = 'gewoon')
                                and (overleg.datum > 20100000 and overleg.datum < 20101232)
...
$query = "select functies.naam, count(distinct overleg.id)
          ...
          where overleggenre = 'gewoon'
            and patient.code = overleg.patient_code and overleg.datum >= 20100000  and overleg.datum <= 20101232
...
select count(distinct patient_code)
                              ...
                              where (overleg.genre is NULL or overleg.genre = 'gewoon')
                                and (overleg.datum > 20100000 and overleg.datum < 20101232)
                                and (gebdatum < 19460000)
";
$csvOutput .= "********;**********;*******;******\n";
$csvOutput .= "Patienten Ouder dan 65 Hasselt (geboren voor 1/1/1946)\n";
csvRecords($qryPatsMetOverleg);
...
";
$csvOutput .= "********;**********;*******;******\n";
$csvOutput .= "Patienten Jonger dan 65 Hasselt (geboren na 1/1/1946)\n";
csvRecords($qryPatsMetOverleg);
...
";
$csvOutput .= "********;**********;*******;******\n";
$csvOutput .= "Patienten Ouder dan 65 Genk (geboren voor 1/1/1946)\n";
csvRecords($qryPatsMetOverleg);
...
";
$csvOutput .= "********;**********;*******;******\n";
$csvOutput .= "Patienten Jonger dan 65 Genk (geboren na 1/1/1946)\n";
csvRecords($qryPatsMetOverleg);
