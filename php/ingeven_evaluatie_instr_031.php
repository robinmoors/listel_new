...
//------------------------------------------------------------
   ...
   session_start();
   $paginanaam="Evaluatieinstrument Stap 3.1.";
...
function checkRadios(){var melding="";
	waarde=""
	var radios= new Array("ei_031_04_s","ei_031_05_s","ei_031_06_s","ei_031_03_s");
...
switch(true)
	...
	case(!(isset($_POST['action']))):
		...
		if((isset($_SESSION['action']))AND($_SESSION['action']=="Aanpassen"))
			...
			$qry="
				SELECT
					ei_031_01_s,ei_031_01_t,
					ei_031_02_s,ei_031_02_t,
					ei_031_03_s,ei_031_03_t,
					ei_031_04_s,ei_031_04_t,
					ei_031_05_s,ei_031_05_t,
					ei_031_06_s,ei_031_06_t,
					ei_031_07_s,ei_031_07_t,
					ei_031_08_s,ei_031_08_t
				FROM
					evalinstr
				WHERE
...
?>
<!-- Start Formulier -->
<form action="ingeven_evaluatie_instr_031.php" method="post" name="evaluatieInstrForm" onsubmit="return checkRadios()">
   <fieldset>
...
?>
					<td>Controle parameters</td>
					<td align="center"><input type="text"  name="ei_031_01_t" size="35" value="<?php print($Var_ei_031_01_t);?>" /></td>
				</tr>
            <tr>
<?php 
...
?>
					<td>Observatie</td>
					<td align="center"><input type="text"  name="ei_031_02_t" size="35" value="<?php print($Var_ei_031_02_t);?>" /></td>
				</tr>
            <tr class="verplicht">
					<td colspan="6" class="titel"><b>Medicatie verzorgingsmateriaal :&nbsp;</b></td>
				</tr>
            <tr class="verplicht">
<?php 
...
?>
					<td>&nbsp;&nbsp;&bull;&nbsp;Aanschaf</td>
					<td align="center"><input type="text"  name="ei_031_03_t" size="35" value="<?php print($Var_ei_031_03_t);?>" /></td>
				</tr>
            <tr class="verplicht">
<?php 
...
?>
					<td>&nbsp;&nbsp;&bull;&nbsp;Klaarzetten/Pillendoos?</td>
					<td align="center"><input type="text"  name="ei_031_04_t" size="35" value="<?php print($Var_ei_031_04_t);?>" /></td>
				</tr>
            <tr class="verplicht">
<?php 
...
?>
					<td>&nbsp;&nbsp;&bull;&nbsp;Innemen/Gebruiken</td>
					<td align="center"><input type="text"  name="ei_031_05_t" size="35" value="<?php print($Var_ei_031_05_t);?>" /></td>
				</tr>
            <tr class="verplicht">
<?php 
...
?>
					<td>&nbsp;&nbsp;&bull;&nbsp;Overige...</td>
					<td align="center"><input type="text"  name="ei_031_06_t" size="35" value="<?php print($Var_ei_031_06_t);?>" /></td>
				</tr>
            <tr>
<?php 
...
?>
					<td>Allergische reacties</td>
					<td align="center"><input type="text"  name="ei_031_07_t" size="35" value="<?php print($Var_ei_031_07_t);?>" /></td>
				</tr>
            <tr>
<?php 
...
?>
					...
					<td align="center"><input type="text"  name="ei_031_08_t" size="35" value="<?php print($Var_ei_031_08_t);?>" /></td>
				</tr>
            </table>
      </div>
   </fieldset>
...
<?php
	...
	case((isset($_POST['action']))AND($_POST['action']=="Opslaan")):
		...
		$qry="
				UPDATE evalinstr
				SET
					ei_031_01_s=".check4empty('ei_031_01_s').",ei_031_01_t='".$_POST['ei_031_01_t']."',
					ei_031_02_s=".check4empty('ei_031_02_s').",ei_031_02_t='".$_POST['ei_031_02_t']."',
					ei_031_03_s=".check4empty('ei_031_03_s').",ei_031_03_t='".$_POST['ei_031_03_t']."',
					ei_031_04_s=".check4empty('ei_031_04_s').",ei_031_04_t='".$_POST['ei_031_04_t']."',
					ei_031_05_s=".check4empty('ei_031_05_s').",ei_031_05_t='".$_POST['ei_031_05_t']."',
					ei_031_06_s=".check4empty('ei_031_06_s').",ei_031_06_t='".$_POST['ei_031_06_t']."',
					ei_031_07_s=".check4empty('ei_031_07_s').",ei_031_07_t='".$_POST['ei_031_07_t']."',
					ei_031_08_s=".check4empty('ei_031_08_s').",ei_031_08_t='".$_POST['ei_031_08_t']."'
				WHERE
                    ei_id = {$_SESSION['evalinstr_id']}";
//			print($qry);
		...
		document.location=\"ingeven_evaluatie_instr_032.php\"
